...
class NET(torch.nn.Module):
    ...
    def observe(self, data_loader, loss_criterion, task_i, args, prev_model, last_epoch=False, device=None):
        """
            ...
            if task_i > 0:
                ...
                if prev_model is not None:
                    ...
                    for oldt in range(task_i):
                        ...
                        step_dce_loss = nn.CosineEmbeddingLoss()(dist_logits.reshape(1, -1), dist_target.reshape(1, -1), torch.ones(1).to(device=device))
    ...
    def observe_clsIL(self, data_loader, loss_criterion, task_i, args, prev_model, last_epoch=False, device=None):
        """
